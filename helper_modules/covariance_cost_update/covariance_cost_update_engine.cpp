...
void update_engine_covariance_cost(arg_struct_t* argStruct_p, int which_update){
...
switch (which_update){
    case 1:
      start_rtn=compute_tr_E_E_xw_thread_start;
      ...
      strcpy(argStruct_p->update_string,"compute_tr_E_E_xw_thread_start");
      ...
      break;
    case 2:
      start_rtn=compute_Partial_Covariance_Cost_wrt_Zol_thread_start;
      dim1_len=(double)O_static;  
      dim2_len=(double)L_static;

      dim_flag=true; 

      strcpy(argStruct_p->update_string,"compute_Partial_Covariance_Cost_wrt_Zol_thread_start");      

      break;
    case 3:
      start_rtn=compute_Partial_Covariance_Cost_wrt_Ylk_thread_start;
      dim1_len=(double)L_static; 
      dim2_len=(double)K_static;

      dim_flag=true; 

      strcpy(argStruct_p->update_string,"compute_Partial_Covariance_Cost_wrt_Ylk_thread_start");      

      break;                  

}

mexPrintf("update_engine_covariance_costs, line 110: pthread_self(): %d, which_update: %d\n", (int)pthread_self(), which_update);
