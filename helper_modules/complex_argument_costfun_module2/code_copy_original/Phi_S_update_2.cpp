...
cx_cube::fixed<F_static, N_static, K_static> Pwrt_Xh1_fnk;
cube::fixed<F_static, N_static, K_static> Pwrt_arg_Xh1_fnk;
...
cube::fixed<F_static, N_static, K_static> Pwrt_H1_fnk;	/*Can be used as a dummy variable while you are computing the num and den functions at first*/	/*This should come in as imag(*Xhat_fnm_p.slice(m_index)) spreaded over k*/
cube::fixed<F_static, N_static, K_static> Pwrt_H1_num_fnk; 	/*This should come in as real(*Xhat_fnm_p.slice(m_index)) spreaded over k*/
...
cube::fixed<F_static, N_static, K_static> G1_fn_spreaded_fnk;
cube::fixed<F_static, N_static, K_static> H1_fn_spreaded_fnk;

cube::fixed<F_static, N_static, K_static> sqrt_denmat_1_fnk;
...
void Phi_S_update2_entry(arg_struct_t* argStruct_p){
