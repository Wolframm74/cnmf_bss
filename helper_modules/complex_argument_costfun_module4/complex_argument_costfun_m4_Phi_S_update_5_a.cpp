...
static cx_mat::fixed<O_static, L_static> Phi_S_complex_argument_m4_fnk_spreadmat_OL[NUM_WORKER_THREADS_COMPLEX_ARGUMENT_COSTFUN_M4];
static cx_mat::fixed<O_static, L_static> Phi_S_complex_argument_m4_fng_spreadmat_OL[NUM_WORKER_THREADS_COMPLEX_ARGUMENT_COSTFUN_M4];
...
/*Phi_S(f,n,g) den stuff: Formula: (  1st term + 2nd term )%(3rd term) */	
/*
// 1st term	
...
Phi_S_complex_argument_m4_fnk_spreadmat_OL[thread_iter].zeros();
Phi_S_complex_argument_m4_fng_spreadmat_OL[thread_iter].zeros();

for (k_index=0; k_index<K_static; k_index++){

Phi_S_complex_argument_m4_fnk_spreadmat_OL[thread_iter]=Phi_S_complex_argument_m4_fnk_spreadmat_OL[thread_iter]+((( conj(complex_argument_costfun_m4_Error_mat_FN(f_index, n_index))*conj((*Xhat_fnm_p)(f_index, n_index, complex_argument_costfun_m4_m_index_a))*kron( trans((*W_fom_cx_p).slice(complex_argument_costfun_m4_m_index_b).row(f_index)) , trans(ones_col_Lx1) ) )+( complex_argument_costfun_m4_Magnitude_model_mat_FN(f_index, n_index)*((*Xhat_low_fnm_p)(f_index, n_index, complex_argument_costfun_m4_m_index_a))*conj((*expj_Phi_S_nkf_p)(n_index, k_index, f_index))*kron( trans((*W_fom_p).slice(complex_argument_costfun_m4_m_index_b).row(f_index)) , trans(ones_col_Lx1) ) ))%( ((*V_nk_p)(n_index, k_index))*((*T_fk_p)(f_index, k_index))*(*Z_ol_p)%kron(ones_col_Ox1, trans((*Y_lk_p).col(k_index)) ) ));
Phi_S_complex_argument_m4_fng_spreadmat_OL[thread_iter]=Phi_S_complex_argument_m4_fng_spreadmat_OL[thread_iter]+((( (complex_argument_costfun_m4_Error_mat_FN(f_index, n_index))*conj((*Xhat_fnm_p)(f_index, n_index, complex_argument_costfun_m4_m_index_b))*kron( trans((*W_fom_cx_p).slice(complex_argument_costfun_m4_m_index_a).row(f_index)) , trans(ones_col_Lx1) ) )+( complex_argument_costfun_m4_Magnitude_model_mat_FN(f_index, n_index)*((*Xhat_low_fnm_p)(f_index, n_index, complex_argument_costfun_m4_m_index_b))*conj((*expj_Phi_S_nkf_p)(n_index, k_index, f_index))*kron( trans((*W_fom_p).slice(complex_argument_costfun_m4_m_index_a).row(f_index)) , trans(ones_col_Lx1) ) ))%( ((*V_nk_p)(n_index, k_index))*((*T_fk_p)(f_index, k_index))*(*Z_ol_p)%kron(ones_col_Ox1, trans((*Y_lk_p).col(k_index)) ) ));

Phi_S_complex_argument_m4_outmat_NKF(n_index, k_index, f_index)=accu(Phi_S_complex_argument_m4_fnk_spreadmat_OL[thread_iter])+accu(Phi_S_complex_argument_m4_fng_spreadmat_OL[thread_iter]);

Phi_S_complex_argument_m4_outmat_NKF(n_index, k_index, f_index)=((cx_double)2)*Phi_S_complex_argument_m4_outmat_NKF(n_index, k_index, f_index);
...
/*Phi_S_complex_argument_m4_outmat_NKF(n_index, k_index, f_index)=2*accu(Phi_S_complex_argument_m4_fnk_spreadmat_OL[thread_iter])+2*accu(Phi_S_complex_argument_m4_fng_spreadmat_OL[thread_iter]);*/
...
(*expj_Phi_S_nkf_p)=conj(Phi_S_complex_argument_m4_outmat_NKF+outtensor_target_cx_NKF);

/*FKN update below*/
(*expj_Phi_S_fkn_p)=conj(Phi_S_complex_argument_m4_outmat_FKN+outtensor_target_cx_FKN);
