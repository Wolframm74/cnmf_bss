...
cx_cube::fixed<F_static, N_static, K_static> P_Xh1_wrt_Vnk_fnk;
...
cube::fixed<F_static, N_static, K_static> P_G1_wrt_Vnk_fnk;
...
cube::fixed<F_static, N_static, K_static> P_H1_wrt_Vnk_fnk;

cube::fixed<F_static, N_static, K_static> P_H1_wrt_Vnk_num_fnk;
...
cube::fixed<F_static, N_static, K_static> P_arg_Xh1_wrt_Vnk_fnk;
...
/*Function local data*/
mat::fixed<N_static, K_static> Pwrt_C_Vnk_nk;
mat::fixed<N_static, K_static> Pwrt_C_Vnk_nk_mth_component;
...
void V_update2_entry(arg_struct_t* argStruct_p){
