...
(*(argStruct_p->V_nk_p)).elem(find((*(argStruct_p->V_nk_p))>10)).fill(10);*/		/*disable temporarily*/
...
(*(argStruct_p->Z_ol_p)).elem(find((*(argStruct_p->Z_ol_p))>1)).fill(1);*/			/*disable temporarily*/
...
/*relate_significant_Zl_clusters_to_Yl_Clusters(argStruct_p->Z_ol_p, argStruct_p->Y_lk_p);*/	/*disable temporarily*/
...
/*Y_pull_up_vector_elements_generalized_gaussian_wrapper(argStruct_p->Y_lk_p);*/	/*disable temporarily*/
...
/*balance_energies_of_Ltarget_most_significant_clusters(argStruct_p->Y_lk_p);*/		/*disable temporarily*/
...
normalize_Z_ok_compensate_T(argStruct_p->Z_ol_p, argStruct_p->Y_lk_p, argStruct_p->T_fk_p);
