...
while(threads_while_condition_0th_sum_flag&&(!(*last_element_p))) {		/*Change b_exit_cond_global to b_exit_cond_global_0th_sum?? */
	...
	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d returned from calculate_queue_index() with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d about to enter from compute_0th_sum() with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d returned from compute_0th_sum() with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d TRYING TO ENTER SLEEP BLOCK!!!!!, last_element flag = %d, work_actually_computed_ctr=%d, last_element_found_global_flag=%d, work_actually_completed_flag=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)last_element_found_global_flag, (int)work_actually_completed_flag, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d ABOUT TO GO TO SLEEP!!!!!, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d JUST WOKE UP FROM SLEEP!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);

	sem_wait(&threads_asleep_sem);

	threads_asleep_ctr--;

	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d DECREMENTED threads_asleep_ctr!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	if (threads_asleep_ctr==0){
		...
		mexPrintf("Xhat_0th_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d SET check_queue_global_flag BACK TO TRUE!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_0th_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d SUCCESSFULLY EXITED THE WHILE LOOP!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
...
while(threads_while_condition_1st_sum_flag&&(!(*last_element_p))) {		/*Change b_exit_cond_global to b_exit_cond_global_0th_sum?? */
	...
	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d returned from calculate_queue_index() with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d about to enter from compute_1st_sum() with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d returned from compute_1st_sum() with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d TRYING TO ENTER SLEEP BLOCK!!!!!, last_element flag = %d, work_actually_computed_ctr=%d, last_element_found_global_flag=%d, work_actually_completed_flag=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)last_element_found_global_flag, (int)work_actually_completed_flag, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d ABOUT TO GO TO SLEEP!!!!!, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d JUST WOKE UP FROM SLEEP!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);

	sem_wait(&threads_asleep_sem);

	threads_asleep_ctr--;

	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d DECREMENTED threads_asleep_ctr!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	if (threads_asleep_ctr==0){
		...
		mexPrintf("Xhat_1st_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d SET check_queue_global_flag BACK TO TRUE!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_1st_sum_start: pthread_self(): %d with m_index= %d, compute_flag=%d, threads_asleep_ctr=%d SUCCESSFULLY EXITED THE WHILE LOOP!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
...
while(threads_while_condition_2nd_sum_flag&&(!(*last_element_p))) {		/*Change b_exit_cond_global to b_exit_cond_global_0th_sum?? */
	...
	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d returned from calculate_pair_queue_indices() with m_index= %d, f_index=%d, threads_asleep_ctr=%d, compute_flag=%d, last_element_found_global_flag=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index, threads_asleep_ctr, (int)compute_flag, (int)last_element_found_global_flag, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d about to enter from compute_2nd_sum() with m_index= %d, f_index=%d,  compute_flag=%d, threads_asleep_ctr=%d, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index,  (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d returned from compute_2nd_sum() with m_index= %d, f_index=%d, threads_asleep_ctr=%d, compute_flag=%d, last_element_found_global_flag=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index, threads_asleep_ctr, (int)compute_flag, (int) last_element_found_global_flag, (int)check_queue_global_flag);	
	...
	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d with m_index= %d, f_index=%d,  compute_flag=%d, threads_asleep_ctr=%d TRYING TO ENTER SLEEP BLOCK!!!!!, last_element flag = %d, work_actually_computed_ctr=%d, last_element_found_global_flag=%d, work_actually_completed_flag=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index,  (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)last_element_found_global_flag, (int)work_actually_completed_flag, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d with m_index= %d, f_index=%d,  compute_flag=%d, threads_asleep_ctr=%d ABOUT TO GO TO SLEEP!!!!!, last_element flag = %d, work_actually_computed_ctr=%d, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index,  (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d with m_index= %d, f_index=%d,  compute_flag=%d, threads_asleep_ctr=%d JUST WOKE UP FROM SLEEP!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index,  (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);

	sem_wait(&threads_asleep_sem);

	threads_asleep_ctr--;

	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d with m_index= %d, f_index=%d,  compute_flag=%d, threads_asleep_ctr=%d DECREMENTED threads_asleep_ctr!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index,  (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	if (threads_asleep_ctr==0){
		...
		mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d with m_index= %d, f_index=%d,  compute_flag=%d, threads_asleep_ctr=%d SET check_queue_global_flag BACK TO TRUE!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index,  (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
	...
	mexPrintf("Xhat_2nd_sum_start: pthread_self(): %d with m_index= %d, f_index=%d,  compute_flag=%d, threads_asleep_ctr=%d SUCCESSFULLY EXITED THE WHILE LOOP!!!!!, last_element flag = %d, work_actually_computed_ctr, check_queue_global_flag=%d \n", (int) pthread_self(), m_index, f_index,  (int)compute_flag, threads_asleep_ctr, (int)(*last_element_p), work_actually_computed_ctr, (int)check_queue_global_flag);
...
mexPrintf("Xhat_start: pthread_self():%d, After Xhat_0th_sum_start(), work_queue_size=%d !!!!!!!!!!!!!!!!!!!!!!!!!!!, check_queue_global_flag=%d \n", (int)pthread_self(), argStruct_p->work_queue_size, (int)check_queue_global_flag);

if (threads_asleep_ctr<(NUM_WORKER_THREADS-1)){

	mexPrintf("Xhat_start: pthread_self():%d, After Xhat_0th_sum_start(), checking if work_actually_computed_ctr<argStruct_p->work_queue_size=%d!!!!!!!!!!!!, check_queue_global_flag=%d \n", (int)pthread_self(), argStruct_p->work_queue_size, (int)check_queue_global_flag);
...
mexPrintf("Xhat_start: pthread_self():%d, returned from Xhat_0th_sum_start() AND ABOUT TO REPOPULATE QUEUE FROM THE OUTSIDE WORLD!!!!!!!!!!!!!!!!!!!1, check_queue_global_flag=%d\n", (int)pthread_self(), (int)check_queue_global_flag);
...
/*Wake the other threads by calling sem_post() three times. */
	...
	mexPrintf("Xhat_start: pthread_self():%d, After Xhat_0th_sum_start() SEM_POST() TIMES THREE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!, check_queue_global_flag=%d\n", (int)pthread_self(), (int)check_queue_global_flag);
...
/*Wake the other threads by calling sem_post() three times. */
	...
	mexPrintf("Xhat_start: pthread_self():%d, After Xhat_1st_sum_start() SEM_POST() TIMES THREE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!, check_queue_global_flag=%d \n", (int)pthread_self(), (int)check_queue_global_flag);
...
mexPrintf("Xhat_start: pthread_self():%d, After Xhat_2nd_sum_start(), work_queue_size=%d !!!!!!!!!!!!!!!!!!!!!!!!!!!, check_queue_global_flag=%d \n", (int)pthread_self(), argStruct_p->work_queue_size, (int)check_queue_global_flag);

/*sem_wait(&work_actually_computed_sem);*/

if (threads_asleep_ctr<(NUM_WORKER_THREADS-1)){

	mexPrintf("After Xhat_2nd_sum_start(), checking if work_actually_computed_ctr<argStruct_p->work_queue_size=%d!!!!!!!!!!!!, check_queue_global_flag=%d \n", (int)pthread_self(), argStruct_p->work_queue_size, (int)check_queue_global_flag);
...
mexPrintf("Xhat_start: pthread_self():%d, pthread_self():%d returned from Xhat_2nd_sum_start() AND ABOUT TO REPOPULATE QUEUE FROM THE OUTSIDE WORLD!!!!!!!!!!!!!!!!!!!1, check_queue_global_flag=%d\n", (int)pthread_self(), (int)check_queue_global_flag);
...
/*Wake the other threads by calling sem_post() three times. */
	...
	mexPrintf("Xhat_start: pthread_self():%d, After Xhat_2nd_sum_start() SEM_POST() TIMES THREE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!, check_queue_global_flag=%d \n", (int)pthread_self(), (int)check_queue_global_flag);
